...
public class MainWin extends JFrame {
	...
	bOrder  = new JButton(new ImageIcon("gui/resources/"));
          bOrder.setActionCommand("Create new Order");
          bOrder.setToolTipText("Create a new order");
          toolbar.add(bOrder);
          //bOrder.addActionListener(event -> onCreateJavaClick());
	...
	bServer  = new JButton(new ImageIcon("gui/resources/"));
          bServer.setActionCommand("Create new server");
          bServer.setToolTipText("Create a new server");
          toolbar.add(bServer);
          //bServer.addActionListener(event -> onCreateJavaClick());

        toolbar.add(Box.createHorizontalStrut(25));

	bListOrders  = new JButton(new ImageIcon("gui/resources/"));
          bListOrders.setActionCommand("List orders");
          bListOrders.setToolTipText("List orders");
          toolbar.add(bListOrders);
          //bListOrders.addActionListener(event -> onCreateJavaClick());
    ...
    private JButton bOrder;                 // Button to create a new Order
